...
public class MyGoodsAdapter extends BaseAdapter {
	 ...
	 * construct
	 */
	public MyGoodsAdapter(Context c, List<Goods> items) {
		mContext = c;
		this.items = items;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null)
		{
			convertView = LayoutInflater.from(mContext).inflate(R.layout.new_mygoods_row, null);
//			convertView.setBackgroundColor(0xffFBF9F2);
		...
		((TextView) convertView.findViewById(R.id.tvUseTime)).setText(e.iUseTime);
		((TextView) convertView.findViewById(R.id.tvDes)).setText(e.iDesc);
		((TextView) convertView.findViewById(R.id.tvOverplusTime)).setText(e.iOverplusTime);
