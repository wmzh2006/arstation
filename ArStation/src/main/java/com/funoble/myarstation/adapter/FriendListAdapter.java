...
public class FriendListAdapter extends BaseAdapter {
	 ...
	 * construct
	 */
	public FriendListAdapter(Context c, List<FriendListInfo> items) {
		mContext = c;
		this.items = items;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Tools.debug("FriendListAdapter::getView 95");
		if (convertView == null) {
...
//			convertView.setBackgroundColor(0xffFBF9F2);
		...
		convertView.setOnClickListener(new Buttonclick(e.iFriendUserID, position));
...
//			setSelectedRow(v);
			Pair<Integer, Integer> pair = new Pair<Integer, Integer>(id, pos);	
