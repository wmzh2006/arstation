...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.drawable.new_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.drawable.new_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.drawable.new_autocrop);
    }
