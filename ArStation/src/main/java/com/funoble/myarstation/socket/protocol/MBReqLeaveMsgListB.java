...
public class MBReqLeaveMsgListB implements MsgPara {
	public int		iUserID; 		//用户ID
	public int		iStartIndex;	 //开始索引号
	/**
	 * construct
	 */
	public MBReqLeaveMsgListB() {
		iUserID = 0;
		iStartIndex = 0;
	}
	...
	public String toString() {
		return "MBReqLeaveMsgListB [iUserID=" + iUserID + ", iStartIndex="
				+ iStartIndex + "]";
	}
