...
public class MBRspUseItem implements MsgPara {
	...
	public String toString() {
		return "MBRspUseItem [nResult=" + nResult + ", iMsg=" + iMsg
				+ ", iItemID=" + iItemID + ", iItemCount=" + iItemCount + "]";
	}
}
