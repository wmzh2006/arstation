...
public class MBRspGiftFriendGoodsTwo implements MsgPara {
	...
	public int		iCurrentGb;					//自己当前的金币
	public int		iGoodsID;					//赠送的物品ID

	/**
	 * construct
	 */
	public MBRspGiftFriendGoodsTwo() {
		nResult = -1;
		iMsg = "";
		iMoney = 0;
		iAddFriendExp = 0;
