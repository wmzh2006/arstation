...
public class MBRspCreateRole implements MsgPara {
	...
	public String toString() {
		return "MBRspCreateRole [nResult=" + nResult + ", iMsg=" + iMsg
				+ ", iModelID=" + iModelID + ", iNick=" + iNick + "]";
	}
}
