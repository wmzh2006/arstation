...
public class MBNotifyPlayAnimation implements MsgPara {
	public int	 iAnimationID;	//动画ID
	public int	 iUserSeatID;	//使用者座位ID
	public int	 iDesSeatID;	 //目标座位ID
	/**
	 * construct
	 */
	public MBNotifyPlayAnimation() {
		iAnimationID = 0;
		iUserSeatID = 0;
		iDesSeatID = 0;
	}
	...
	public String toString() {
		return "MBNotifyPlayAnimation [iAnimationID=" + iAnimationID
				+ ", iUserSeatID=" + iUserSeatID + ", iDesSeatID=" + iDesSeatID
				+ "]";
	}
