...
public class MBReqFeekBack implements MsgPara {
	...
	public int Encode(byte[] aOutBuffer, short aOutLength) {
		...
		if(iContent.length() > BufferSize.MAX_FeedBack_LEN) {
			return -1;
		}
	...
	public String toString() {
		return "MBReqFeekBack [iContent=" + iContent + "]";
	}
}
