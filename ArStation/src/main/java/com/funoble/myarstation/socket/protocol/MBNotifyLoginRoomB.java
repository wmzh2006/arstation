...
public class MBNotifyLoginRoomB implements MsgPara {
	...
	public int		iCarPakID;						//玩家汽车的PakID
	public int		iVIPLevel;						//玩家的VIP级别

	/**
	 * construct
	 */
	public MBNotifyLoginRoomB() {
		iSeatID = -1;
		iUserName = "";
		iModelID = 0;
		iUserState = 0;
	...
	public String toString() {
		return "MBNotifyLoginRoom [iSeatID=" + iSeatID + ", iUserName="
				...
				+ ", iCarPakID=" + iCarPakID + ", iVIPLevel=" + iVIPLevel + "]";
	}
