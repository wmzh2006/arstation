...
public class MBReqGiftFriendGoodsTwo implements MsgPara {
	 ...
	 * construct
	 */
	public MBReqGiftFriendGoodsTwo() {
		iDesUserID = 0;
		iGoodsID = 0;
		iCount = 0;
	}
	...
	public String toString() {
		return "MBReqGiftFriendGoodsTwo [iDesUserID=" + iDesUserID + ", iGoodsID=" + iGoodsID
				+ ", iCount=" + iCount + "]";
	}
