...
public class MBRspMainPageB implements MsgPara {
	...
	public int			iReward;					//是否有每日登录奖励 0 --- 没有  1 --- 有（原来是奖，一直没有用)
	...
	public String		iUrl;						//网址    格式：基础网址|礼品页面|每日奖励页面|公告页面
	
	public MBRspMainPageB() {
		this.iResult = -1;
		this.iMsg = "";
		this.iUserId = 0;
		this.iNick = "";
	...
	public String toString() {
		return "MBRspMainPageB [iResult=" + iResult + ", iMsg=" + iMsg
				...
				+ ", iBigPicName=" + iBigPicName + ", iZhaiSkill=" + iZhaiSkill
				+ ", iUrl=" + iUrl + "]";
	}
