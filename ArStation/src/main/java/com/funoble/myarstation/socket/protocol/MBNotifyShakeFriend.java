...
public class MBNotifyShakeFriend implements MsgPara {
	...
	public String toString() {
		return "MBNotifyShakeFriend [iDesSeatID=" + iDesSeatID
				+ ", iCurrentDrunk=" + iCurrentDrunk + ", iDesUserID="
				+ iDesUserID + "]";
	}
