...
public class MBRspLoginRoomB implements MsgPara {
	...
	public String toString() {
		return "MBRspLoginRoomB [iResult=" + iResult + ", iMsg=" + iMsg
				...
				+ iVIPLevels + ", iLogicType=" + iLogicType + ", iBetGB="
