 ...
 * FileName: MBRspCommitPlayerData.java 
 * Description:
 * History:  
 * 版本号 作者 日期 简要介绍相关操作 
...
public class MBRspCommitPlayerData implements MsgPara {
	...
	public String toString() {
		return "MBRspCommitPlayerData [nResult=" + nResult + ", iMsg=" + iMsg + "]";
	}
}
