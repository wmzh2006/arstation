...
public class MBRspLeaveMsgListB implements MsgPara {
	...
	public Vector<Short>	iType;			//类型 0 --- 普通    1 --- 私信 
	/**
	 * construct
	 */
	public MBRspLeaveMsgListB() {
		iResult = -1;
		iMsg = "";
		iStartIndex = 0;
		iAllMsgCount = 0;
	...
	public String toString() {
		return "MBRspLeaveMsgListB [iResult=" + iResult + ", iMsg=" + iMsg
