...
public class MBRspRegisterB implements MsgPara {
	...
	public int Decode(byte[] aInBuffer, short aInLength) {
		...
		int userPswdLen = Temp.getShort();
		if(userPswdLen > 0) {
			byte[] usePswd = new byte[userPswdLen];
			Temp.get(usePswd);
			iUserPswd = new String(usePswd);
			usePswd = null;
		}
	...
	public String toString() {
		return "MBRspRegister [nResult=" + nResult + ", iMsg=" + iMsg
				+ ", iUserID=" + iUserID + ", iUserPswd=" + iUserPswd + "]";
	}
