...
public class MBNotifyKick implements MsgPara {
	...
	public String toString() {
		return "MBNotifyKick [iResult=" + iResult + ", iMsg=" + iMsg
				+ ", iWineName=" + iWineName + ", iPrice=" + iPrice
				+ ", iWineCount=" + iWineCount + ", iSeatID=" + iSeatID + "]";
	}
