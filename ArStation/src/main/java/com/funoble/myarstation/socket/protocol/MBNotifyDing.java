...
public class MBNotifyDing implements MsgPara {
	public int		iUserSeatID;			//使用者座位ID
	public int     	iDesSeatID;				//目标座位ID
	public int		iSpriteType;			//动画类型
	...
	public String toString() {
		return "MBNotifyDing [iUserSeatID=" + iUserSeatID + ", iDesSeatID="
				+ iDesSeatID + ", iSpriteType=" + iSpriteType + "]";
	}
}
