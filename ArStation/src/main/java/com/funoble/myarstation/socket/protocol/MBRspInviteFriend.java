 ...
 * FileName: MBRspInviteFriend.java 
 * Description:
 * History:  
 * 版本号 作者 日期 简要介绍相关操作 
...
public class MBRspInviteFriend implements MsgPara {
	public short    iResult;				//结果
	public String	iMsg;					//消息
	public int 		iGB;					//当前剩下的金币
	public int		iAddGB;				   //加的金币

	/**
	 * construct
	 */
	public MBRspInviteFriend() {
		iResult = -1;
		iMsg = "";
		iGB = 0;
		iAddGB =  0;
	...
	public String toString() {
		return "MBRspInviteFriend [iResult=" + iResult + ", iMsg=" + iMsg
				+ ", iGB=" + iGB + ", iAddGB=" + iAddGB + "]";
	}
